...
class ActionHistoryComponent(
    ...
    def get_messages(self) -> Iterator[ChatMessage]:
        ...
        # Include a summary for every step, including the latest ones
        ...
        if step_summaries:
            ...
            # Append raw parsed content directly to thoughts.jsonl
            with open("/logs/step_summaries.txt", "w") as f:
                f.write("\n".join(step_summaries) + "\n")
