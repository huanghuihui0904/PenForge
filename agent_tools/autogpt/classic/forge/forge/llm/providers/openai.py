...
class OpenAIModelName(str, enum.Enum):
    ...
    # 🚀 GPT-4.1 family
    # GPT4_1_v1 = "gpt-4.1-2024-12-05"
    GPT4_1_v2 = "gpt-4.1-2025-04-14"   # <--- new model you asked for
...
OPEN_AI_CHAT_MODELS = {
    ...
    for info in [
        ...
        # ChatModelInfo(
        #     name=OpenAIModelName.GPT4_1_ROLLING,
        #     provider_name=ModelProviderName.OPENAI,
        #     prompt_token_cost=0.005 / 1000,   # adjust to actual pricing if known
        #     completion_token_cost=0.015 / 1000,
        #     max_tokens=128000,
        #     has_function_call_api=True,
        # ),
        ChatModelInfo(
            name=OpenAIModelName.GPT4_1_v2,   # <--- new model you asked for
            provider_name=ModelProviderName.OPENAI,
            prompt_token_cost=0.005 / 1000,   # adjust to actual pricing if known
            completion_token_cost=0.015 / 1000,
            max_tokens=128000,
...
chat_model_mapping = {
    ...
    OpenAIModelName.GPT4_1_v2: [OpenAIModelName.GPT4_1_v2],
    # OpenAIModelName.GPT4_1_ROLLING: [
    #     OpenAIModelName.GPT4_1_v1,
    #     OpenAIModelName.GPT4_1_v2,   # <--- add new release
    # ],
}
