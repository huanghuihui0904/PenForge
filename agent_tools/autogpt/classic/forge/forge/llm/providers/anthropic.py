...
class AnthropicModelName(str, enum.Enum):
    ...
    # Claude 3.5 models
    CLAUDE3_5_SONNET_v1 = "claude-3-5-sonnet-20241022"
...
ANTHROPIC_CHAT_MODELS = {
    ...
    for info in [
        # Claude 4 models (latest)
        ChatModelInfo(
            name=AnthropicModelName.CLAUDE_4_1_OPUS,
            provider_name=ModelProviderName.ANTHROPIC,
            prompt_token_cost=18 / 1e6,  # Estimated cost for Claude 4.1 Opus
            completion_token_cost=90 / 1e6,  # Estimated cost for Claude 4.1 Opus
            max_tokens=200000,
            has_function_call_api=True,
        ),
        ChatModelInfo(
            name=AnthropicModelName.CLAUDE_4_OPUS,
            provider_name=ModelProviderName.ANTHROPIC,
            prompt_token_cost=15 / 1e6,  # Estimated cost for Claude 4 Opus
            completion_token_cost=75 / 1e6,  # Estimated cost for Claude 4 Opus
            max_tokens=200000,
            has_function_call_api=True,
        ),
        ChatModelInfo(
            name=AnthropicModelName.CLAUDE_4_SONNET,
            provider_name=ModelProviderName.ANTHROPIC,
            prompt_token_cost=3 / 1e6,  # Estimated cost for Claude 4 Sonnet
            completion_token_cost=15 / 1e6,  # Estimated cost for Claude 4 Sonnet
            max_tokens=200000,
            has_function_call_api=True,
        ),
        # Claude 3.7 models (latest)
