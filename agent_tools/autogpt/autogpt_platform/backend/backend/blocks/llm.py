...
MODEL_METADATA = {
    ...
    LlmModel.GPT4_1_v2: ModelMetadata("openai", 1047576, 32768),
    ...
    # Claude 4 family
    LlmModel.CLAUDE_4_1_OPUS: ModelMetadata("anthropic", 200000, 8192),  # claude-opus-4-1-20250805
    LlmModel.CLAUDE_4_OPUS: ModelMetadata("anthropic", 200000, 8192),    # claude-opus-4-20250514
    LlmModel.CLAUDE_4_SONNET: ModelMetadata("anthropic", 200000, 8192),  # claude-sonnet-4-20250514
